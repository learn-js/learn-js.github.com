...
_Canvassing will be available on October 15 at 8 a.m.!_
...
(Get a 50% discount by preordering before the October 15 release)

<br>

### Book + screencasts + live tutoring bundle
...
#### canvassing command-line tool

Use the canvassing command-line tool to generate the basic html & css used in the examples in the book.
...
These free resources will be made available on October 1 along with the release of the book (get access earlier as a sneak peek if you preorder!).
